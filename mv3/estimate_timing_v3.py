...
# Sequence-alignment approach: find actual matching substrings between our
# known lyrics and the whisper transcript, and only trust time anchors at
# those verified matches. Unmatched stretches interpolate locally between
# the nearest anchors, so errors stay contained instead of compounding.

SONG_DURATION = 228.792
HEAD, TAIL = 0.3, 1.0
