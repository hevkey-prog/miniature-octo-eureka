...
THAI_KEYWORDS = [
    # dharma / self-inquiry theme
    ("ทุกข์ทันที", RED), ("ทุกข์", RED), ("ผิดหวัง", RED), ("เจ็บ", RED),
    ("รู้จริง", GOLD), ("รู้แจ้ง", GOLD), ("รู้ตัวดี", GOLD), ("รู้", GOLD),
    ("ตัวจริง", GOLD), ("ตัวที่รู้", GOLD), ("จริง", GOLD),
    ("อิสระ", CYAN), ("ปล่อย", CYAN),
    ("ควบคุม", PURPLE), ("ยึดติด", PURPLE), ("ยึด", PURPLE), ("หลงทาง", PURPLE),
    ("ผู้สร้าง", PURPLE), ("กำหนด", PURPLE),
    ("ดับ", CYAN), ("เกิด", GREEN), ("เกิดใหม่", GREEN), ("กระจก", CYAN),
    ("ทลาย", ORANGE), ("พัง", ORANGE), ("ยุติธรรม", GOLD), ("แน่ใจ", GOLD),
]
EN_KEYWORDS = {
    "suffering": RED, "hurt": RED, "pain": RED, "hurts": RED, "disappointment": RED,
    "know": GOLD, "knows": GOLD, "knowing": GOLD, "knew": GOLD, "knower": GOLD,
    "true": GOLD, "real": GOLD, "sure": GOLD,
    "free": CYAN, "freedom": CYAN,
    "control": PURPLE, "attachment": PURPLE, "creator": PURPLE, "decides": PURPLE,
    "empty": PURPLE, "evil": PURPLE,
    "reborn": GREEN, "rise": GREEN, "rises": GREEN, "gone": CYAN, "end": CYAN,
    "fair": GOLD, "reflection": CYAN, "trained": GOLD,
}
...
ACCENTS_PAL = {
    ...
    "Verse 1 - กระเป๋าทอง": [(255, 255, 255), (255, 255, 255), (255, 224, 130)],
    "Hook": [(255, 224, 130), (255, 255, 255)],
    "Verse 2 - อิสระที่ไม่อิสระ": [(255, 255, 255), (255, 255, 255), (170, 230, 255)],
    "Verse 3 - กระจกที่ไม่เคยเจอตัวจริง": [(255, 255, 255), (255, 255, 255), (170, 230, 255)],
    "Verse 4 - ผู้สร้าง": [(255, 255, 255), (255, 255, 255), (200, 170, 255)],
    "Outro - ทลายทีละคำ": [(255, 255, 255), (255, 224, 130), (255, 255, 255)],
}
